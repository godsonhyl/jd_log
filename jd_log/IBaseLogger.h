#ifndef JD_IBASE_LOGGER_H
#define JD_IBASE_LOGGER_H
...
#define JDLOG_TRACE(logger, ...) logger->trace("[ " + __FILENAME__ + ":" + LOG_STR_HELPER(__LINE__) + " ] " + __VA_ARGS__)
#define JDLOG_DEBUG(logger, ...) logger->debug("[ " + __FILENAME__ + ":" + LOG_STR_HELPER(__LINE__) + " ] " + __VA_ARGS__)
#define JDLOG_INFO(logger, ...) logger->info("[ " + __FILENAME__ + ":" + LOG_STR_HELPER(__LINE__) + " ] " + __VA_ARGS__)
#define JDLOG_WARN(logger, ...) logger->warn("[ " + __FILENAME__ + ":" + LOG_STR_HELPER(__LINE__) + " ] " +__VA_ARGS__)
#define JDLOG_ERROR(logger, ...) logger->error("[ " + __FILENAME__ + ":" + LOG_STR_HELPER(__LINE__) + " ] " + __VA_ARGS__)
#define JDLOG_CRITICAL(logger, ...) logger->critical("[ " + __FILENAME__ + ":" + LOG_STR_HELPER(__LINE__) + " ] " + __VA_ARGS__)
#define JDLOG_OFF(logger, ...) logger->off("[ " + __FILENAME__ + ":" + LOG_STR_HELPER(__LINE__) + " ] " + __VA_ARGS__)
